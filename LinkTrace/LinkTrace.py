...
"""
LinkTrace: Find Usernames Across Social Networks Module
...
module_name = "LinkTrace: Find Usernames Across Social Networks"
__version__ = "0.14.0"


class LinkTraceFuturesSession(FuturesSession):
    def request(self, method, url, hooks={}, *args, **kwargs):
        ...
        return super(LinkTraceFuturesSession, self).request(method,
                                                           url,
                                                           hooks=hooks,
                                                           *args, **kwargs)
...
def LinkTrace(username, site_data, query_notify,
    ...
    session = LinkTraceFuturesSession(max_workers=max_workers,
        ...
        with open(result_file, "w", encoding="utf-8") as file:
            ...
            for website_name in results:
                ...
                if dictionary.get("status").status == QueryStatus.CLAIMED:
                    exists_counter += 1
                    final.append(dictionary["url_user"])
