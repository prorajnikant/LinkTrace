"""LinkTrace: Supported Site Listing
...
with open("LinkTrace/resources/data.json", "r", encoding="utf-8") as data_file:
...
with open("LinkTrace/resources/data.json", "w") as data_file:
